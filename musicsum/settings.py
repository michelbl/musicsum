...
DIR_PREFIX = MICHEL_LINUX_PREFIX # NICO_PREFIX
SEPARATOR = LINUX_SEPARATOR # WINDOWS_SEPARATOR
...
DIR_LABELS = DIR_PREFIX + "labels" + SEPARATOR
DIR_MUTINF_FEATURES = DIR_PREFIX + "mutinf" + SEPARATOR
